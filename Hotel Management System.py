...
def restaurant():
    ...
    for n in range(0, i):
        ...
        if Customer_id[n] == ph and p[n] == 0:
            ...
            # appends in 'Restaurant_charges' list

            r = r + Restaurant_charges.pop(n)

            Restaurant_charges.append(r)
    ...
    for n in range(0, i):
        ...
        if ph == Phone_no[n]:
            ...
            if p[n] == 0:
                ...
                print("\n  Amount: ", (price[n] * day[n]) + Restaurant_charges[n])
                ...
                if ch == 'y' or ch == 'Y':
                    ...
                    print(" Restaurant Charges: \t", Restaurant_charges[n])

                    print(" --------------------------------")

                    print("\n Total Amount: ", (price[n] * day[n]) + Restaurant_charges[n], "\t")
...
def Record():
    ...
    if Phone_no != []:
        ...
        for n in range(0, i):
            print("|", Name[n], "\t |", Phone_no[n], "\t|", address[n], "\t|", checkin[n], "\t|", checkout[n], "\t|", room[n],
                  "\t|", price[n])
